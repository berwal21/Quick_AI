    ...
    <div className="h-full overflow-y-scroll p-6 flex flex-wrap items-start gap-4 text-slate-700">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-semibold">Artilce Configuration</h1>
        </div>
        ...
        <input
          ...
          placeholder="The future of atrificial intelligence is..."
          required
        />
        ...
        bg-gradient-to-r from-[#226BFF] to-[#65ADFF] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer hover:opacity-90"
        >
