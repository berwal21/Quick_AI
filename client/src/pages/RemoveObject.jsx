    ...
    <div className="h-full overflow-y-scroll p-6 flex flex-wrap items-start gap-4 text-slate-700">
      ...
      >
        ...
        <textarea
          ...
          placeholder="e.g,. person, car, tree . Only Single object name"
          required
        />

        <button
          className="w-full flex justify-center items-center gap-2
        bg-gradient-to-r from-[#417DF6] to-[#8E37EB] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer hover:opacity-90"
        >
